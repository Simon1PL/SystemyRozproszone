...
-record('queuesController.declare', {ticket = 0, queuesController = <<"">>, passive = false, durable = false, exclusive = false, auto_delete = false, nowait = false, arguments = []}).
-record('queuesController.declare_ok', {queuesController, message_count, consumer_count}).
-record('queuesController.bind', {ticket = 0, queuesController = <<"">>, exchange, routing_key = <<"">>, nowait = false, arguments = []}).
-record('queuesController.bind_ok', {}).
-record('queuesController.purge', {ticket = 0, queuesController = <<"">>, nowait = false}).
-record('queuesController.purge_ok', {message_count}).
-record('queuesController.delete', {ticket = 0, queuesController = <<"">>, if_unused = false, if_empty = false, nowait = false}).
-record('queuesController.delete_ok', {message_count}).
-record('queuesController.unbind', {ticket = 0, queuesController = <<"">>, exchange, routing_key = <<"">>, arguments = []}).
-record('queuesController.unbind_ok', {}).
-record('basic.qos', {prefetch_size = 0, prefetch_count = 0, global = false}).
-record('basic.qos_ok', {}).
-record('basic.consume', {ticket = 0, queuesController = <<"">>, consumer_tag = <<"">>, no_local = false, no_ack = false, exclusive = false, nowait = false, arguments = []}).
...
-record('basic.get', {ticket = 0, queuesController = <<"">>, no_ack = false}).
...
-record('file.qos_ok', {}).
-record('file.consume', {ticket = 1, queuesController = <<"">>, consumer_tag = <<"">>, no_local = false, no_ack = false, exclusive = false, nowait = false}).
...
-record('stream.consume', {ticket = 1, queuesController = <<"">>, consumer_tag = <<"">>, no_local = false, exclusive = false, nowait = false}).
...
-record('stream.deliver', {consumer_tag, delivery_tag, exchange, queuesController}).
-record('dtx.select', {}).
